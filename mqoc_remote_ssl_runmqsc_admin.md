...
3. To configure the client keystore file you will need tools such as `runmqakm`
  ...
  - There is also a [MacOS toolkit for Developers](https://developer.ibm.com/components/ibm-mq/tutorials/mq-macos-dev/) client that allows native use of runmqsc on MacOS
